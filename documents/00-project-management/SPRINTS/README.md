...
| 034    | R14 Discard-and-Retire Contract Amendment            | Active — sole active sprint (2026-07-30); documentation-and-architecture amendment recording ADR 004 (discard-and-retire; no migrated room, no legacy-state copy); pauses Sprint 031; marks the runbook and Gate 2 documents non-executable; delivered as an unmerged draft PR pending Architect review and Product Owner acceptance |
