...
| 031    | R14c Gate 2 Preflight and Go/No-Go Preparation       | Active — sole active sprint; resumed (2026-07-30) after Sprint 032 closed; tracking scaffold integrated (2026-07-29; PR #28; merge `e7e057b6`); all rows `Not started`; `DEFER / NOT READY`; Gate 2 pending and unauthorized |
...
| 033    | R14c Governance Lifecycle Transition                 | Completed — documentation-only lifecycle bridge; records Sprint 032 closure and restores Sprint 031 as sole active; no status resolved; no GO |
