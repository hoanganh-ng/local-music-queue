...
- **Desired-State:** Defined in individual Sprint documents (under `SPRINTS/`), planning documents, and the project roadmap.
...
- [`ROOM_EPIC_SPRINT_SEQUENCE.md`](ROOM_EPIC_SPRINT_SEQUENCE.md): Planned sprint order for the multi-room, invite, host/player lease, and storage migration epic.
